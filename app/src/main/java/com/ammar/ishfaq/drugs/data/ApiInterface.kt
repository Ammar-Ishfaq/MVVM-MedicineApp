package com.ammar.ishfaq.drugs.data

import com.ammar.ishfaq.drugs.models.drugs.Drugs
import com.ammar.ishfaq.drugs.utility.Constants.API_BASE_URL
import com.ammar.ishfaq.drugs.utility.Constants.DRUGS
...
class ApiInterface @Inject constructor(client: HttpClient) :
    BaseApiService(client, API_BASE_URL) {
     suspend fun getList(): Drugs = get(endpoint = DRUGS)
}
